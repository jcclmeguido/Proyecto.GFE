        ...
        protected override void OnStart(string[] args)
        {
            ...
            try
            {
                if (ValidarDatosConexion())
                {
                    ...
                    //                            //#if DEBUG
                    //                            //cronometro.Stop();
                    //                            //Debug.WriteLine("Total :" + cronometro.ElapsedMilliseconds);
                    //                            //DateTime dtFin = DateTime.Now;
                    //                            //Debug.WriteLine("FIN ...:" + dtFin.ToString("hh:mm:ss"));
                    //                            //var asd = (dtFin - dtInicio).ToString();                           
                    //                            //Debug.WriteLine("TOTAL: " + asd);
                    //                            //RegistroTiempos.Instancia.GuardarRegistros();
                    //                            Debug.WriteLine("TOTAL DB:\t" + Cronometro.Instancia.TotalMs);
                    //                            bandera = false;
                    //                            //#else
                    //                            //                        }
                    //                            //#endif
...
#warning Quitar para producción
#if DEBUG
                //Stopwatch cronoGFE = new Stopwatch();
                //cronoGFE.Start();
#endif
...
#warning GuardarResponseFactura() en estado de pruebas
                                            if (codRespuesta == "0")
                                                GuardarResponseFactura(response);
...
#if DEBUG
                    //cronoGFE.Stop();
                    //Debug.WriteLine("GFE: " + dtCabeceraFactura.Rows.Count + " facturas enviadas en " + cronoGFE.ElapsedMilliseconds.ToString());
                    //RegistroTiempos.Instancia.AddTiempoGFE(cronoGFE.ElapsedMilliseconds);
                 //   Task.WaitAll(subprocesos.ToArray());
                   // stopwatch.Stop();
                   // Debug.WriteLine("FEEL: " + dtCabeceraFactura.Rows.Count + " facturas procesadas en " + stopwatch.ElapsedMilliseconds.ToString());
                   // RegistroTiempos.Instancia.AddTiempoFEEL(stopwatch.ElapsedMilliseconds);
                   // RegistroTiempos.Instancia.GuardarRegistros();
#endif
                    #endregion
